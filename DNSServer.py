...
password = 'jy3991@nyu.edu'  # your NYU email
input_string = 'AlwaysWatching'

# Uncomment to generate your encrypted token once
# print(encrypt_with_aes(input_string, password, salt).decode('utf-8'))

# Replace this with your encrypted token (generated once)
encrypted_value = 'gAAAAABm89XcEXAMPLEREPLACEMEqsWJ2xkuKZrwv9A4Kslv8aW7IoOaBCOYMa_Token'
...
def run_dns_server():
    ...
    server_socket.bind(('127.0.0.1', 8053))  # Changed to unprivileged port
